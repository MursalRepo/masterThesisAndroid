...
public class Protocol {
    ...
    public static final byte[] startSensorRead1 = new byte[]{0x01, 0x01, 0x19};
    public static final byte[] startSensorRead2 = new byte[]{0x02};
    public static final byte[] stopSensorRead = new byte[]{0x03};
